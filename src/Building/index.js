...
const Building = () => {
  return (
    <div className="bg-[#F5F0E9]">
      ...
      <div className=" mx-auto sm:px-4 flex items-center box-border mt-6 buildingAnimation">
        <img
          src="https://maribellevue.wpengine.com/wp-content/uploads/Dreamlife_Mira2_Cam3_Exterior_CityView_Final-1__1.jpg"
          alt="img"
          className="ml-auto mr-auto sm:h-[calc(100vh-80px)] h-[50vh]"
        />
      </div>
      ...
      <div className="mx-auto px-6 lg:mx-auto relative mt-4 xl:px-20 lg:px-16 md:px-12 md:flex items-center gap-8 buildingAnimationRight">
        ...
        <img
          className="w-full mt-4 sm:mt-6 md:mt-0 object-fill md:w-2/4 md:-ml-4 lg:-ml-4 xl:ml-0 buildingAnimationRight md:h-[85vh]"
          src="banner-2.jpeg"
          alt="Sample"
        />
      </div>
